...
namespace ebIViewModels.ExtensionMethods
{
	...
	public static class Iban
	{
		...
		{
			"IBAN enthält ungültige Zeichen.",
			"IBAN Aufbau ist ungültig.",
			"IBAN Prüfziffer ist falsch.",
			"IBAN für Land {0} derzeit nicht verfügbar.",
			"IBAN für Land {0} muss {1} Zeichen lang sein.",
			"IBAN Struktur ist ungültig..",
			"IBAN ist ungültig.",
			"IBAN ist korrekt.",
		};
		...
		public static StatusData IsIbanValid(this string iban, bool cleanText)
		{
			try
			{
				if (cleanText)
