...
namespace ebIModels.Schema.ebInterface4p2
{
    public partial class InvoiceType : ebIModels.Schema.InvoiceModel
    {
        ...
        public void SetInvoiceVersion()
        {
            ...
            base.Version = Schema.InvoiceModel.ebIVersion.V4P2;
        }

        //// ToDo Refactor and move code to ebInterface.cs
        ...
        internal static List<ebISchema> _schemaInfo = new List<ebISchema>()
            {
                ...
                new ebISchema(){Prefix = "eb",Url="http://www.ebinterface.at/schema/4p2/",CacheName = "ebInterface4p2.Invoice.xsd",UseInSchema = true},
                // new ebISchema(){Prefix = "dsig",Url="http://www.w3.org/2000/09/xmldsig#",CacheName = "xmldsig-core-schema.xsd",UseInSchema = true},
                new ebISchema(){Prefix = "ext",Url="http://www.ebinterface.at/schema/4p2/extensions/ext",CacheName = "ebInterface4p2.ebInterfaceExtension.xsd",UseInSchema = true},
                new ebISchema(){Prefix = "sv",Url="http://www.ebinterface.at/schema/4p2/extensions/sv",CacheName = "ebInterface4p2.ebInterfaceExtension_SV.xsd",UseInSchema = true}
            };
