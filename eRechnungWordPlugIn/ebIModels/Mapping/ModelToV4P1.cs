...
using TARGET = ebIModels.Schema.ebInterface4p1;
using ExtensionMethods;
using VM = ebIModels.Models;
using ebIModels.Schema.ebInterface4p1;
...
namespace ebIModels.Mapping.V4p1
{
    public static partial class MapInvoice
    {
        ...
        internal static TARGET.InvoiceType MapModelToV4p1(VM.IInvoiceModel source)
        {
        ...
        private static CountryType GetCountry(VM.CountryType countryType)
        {
            ...
            else
            {
                ...
                cty.Text[0] = VM.CountryCodes.GetFromCode(cty.CountryCode.ToString()).Country;
            }
            return cty;
        }
        ...
        private static ArticleNumberType[] GetArtikelList(List<VM.ArticleNumberType> srcArticle)
        {
            ...
            foreach (VM.ArticleNumberType articleNumberType in srcArticle)
            {
                ...
                art.Text[0] = articleNumberType.Value;
